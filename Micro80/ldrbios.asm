;
; Loader BIOS for Micro80, loosely based on the Loader BIOS for SocZ80
; in turn based in part on the MP/M Loader for SocZ80 by Will Sowerbutts
;
; on CP/M
; zmac ldrbios.asm
...
; you go
;
; At the moment this loader BIOS assumes that it's being run from something
...
conout:     ; write character from C to console
            in a, (SIOACmd)
            bit 2, a
            jr z, conout ; loop again if transmitter is busy
            ld a, c
